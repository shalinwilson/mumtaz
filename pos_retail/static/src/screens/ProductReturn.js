...
odoo.define('pos_retail.screen_products_return', function (require) {
    ...
    var ButtonRefundProductsScreen = screens.ActionButtonWidget.extend({
        template: 'ButtonRefundProductsScreen',
        init: function (parent, options) {
            var self = this;
            this._super(parent, options);
            this.pos.bind('open:return-products-screen', function () {
                self.button_click();
            });
        },
        button_click: function () {
            this.pos.gui.show_screen('return_products');
        },
    ...
    screens.define_action_button({
        'name': 'ButtonRefundProductsScreen',
        'widget': ButtonRefundProductsScreen,
        'condition': function () {
            return this.pos.config.return_products
        }
    });
        ...
        render_screen: function () {
            ...
            $confirm_return.click(function () {
                ...
                if (order) {
                    ...
                    return self.gui.show_screen('product');
                }
            });
        },
        ...
        render_products_return: function () {
            ...
            this.$('.product_row .quantity').on('click', function () {
                ...
                return self.pos.gui.show_popup('number', {
                    title: _t('How many quantities return ?'),
                    value: self.product_selected['quantity_return'],
            ...
            this.$('.product_row .edit_amount').on('click', function () {
                ...
                self.product_selected = product;
                return self.pos.gui.show_popup('number', {
                    title: _t('Price Item return ?'),
                    value: self.product_selected['price_return'],
