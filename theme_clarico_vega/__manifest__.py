{
    ...
    'summary': 'Fully Responsive1, Clean, Modern & Sectioned Odoo Theme. Crafted to be Pixel Perfect, It is suitable for eCommerce Businesses like Furniture, Fashion, Electronics, Beauty, Health & Fitness, Jewellery, Sports etc.',
    'version': '1.7.7',
    'license': 'OPL-1',
    'depends': [
